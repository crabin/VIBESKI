"""
多厂商模型选择器：支持 Ollama、DeepSeek、OpenAI、Anthropic、Google、智谱、通义、月之暗面、百川、零一、SCNET、
腾讯混元、豆包、讯飞星火、百度文心、阶跃星辰、MiniMax、澜舟、面壁、Together、Fireworks、Mistral、Cohere、xAI、Azure OpenAI，以及 custom。
...
PROVIDER_REGISTRY: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "default_models": ["glm-4.7", "glm-4-flash", "glm-5", "glm-4-plus"],
        "needs_api_key": True,
    },
    {
        "id": "qwen",
    ...
    },
    {
        "id": "scnet",
        "name": "中国超算互联网 (SCNET)",
        "description": "国家超算互联网 AI Hub，QwQ-32B / DeepSeek-R1 等",
        "type": "openai_compatible",
        "default_base_url": "https://api.scnet.cn/api/llm/v1",
        "default_models": ["QwQ-32B", "DeepSeek-R1-Distill-Qwen-7B", "DeepSeek-R1"],
        "needs_api_key": True,
    },
    # --- 国内 ---
    {
        ...
        "default_models": ["hunyuan-turbos-latest", "hunyuan-lite", "hunyuan-pro"],
        "needs_api_key": True,
    },
    {
        "id": "doubao",
        "name": "字节豆包 (火山方舟)",
        "description": "火山引擎方舟，豆包等模型，需填 Endpoint ID",
        "type": "openai_compatible",
        "default_base_url": "https://ark.cn-beijing.volces.com/api/v3",
        "default_models": ["doubao-pro-4k", "doubao-seed-1-8-251228", "ep-xxx"],
        "needs_api_key": True,
    },
    {
        "id": "spark",
        "name": "讯飞星火 (Spark)",
        "description": "讯飞星火认知大模型，OpenAI 兼容",
        "type": "openai_compatible",
        "default_base_url": "https://spark-api-open.xf-yun.com/v1",
        "default_models": ["generalv3.5", "generalv3", "spark-x", "generalv4"],
        "needs_api_key": True,
    },
    {
        "id": "wenxin",
        "name": "百度文心 (千帆)",
        "description": "百度千帆大模型平台，OpenAI 兼容",
        "type": "openai_compatible",
        "default_base_url": "https://qianfan.baidubce.com/v2",
        "default_models": ["ernie-3.5-8k", "ernie-4.0-8k", "ernie-speed", "ernie-tiny"],
        "needs_api_key": True,
    },
    {
        "id": "stepfun",
        "name": "阶跃星辰 (StepFun)",
        "description": "Step 系列大模型，完全兼容 OpenAI",
        "type": "openai_compatible",
        "default_base_url": "https://api.stepfun.com/v1",
        "default_models": ["step-1-8k", "step-1-32k", "step-2-16k", "step-1v-8k"],
        "needs_api_key": True,
    },
    {
        "id": "minimax",
        "name": "MiniMax",
        "description": "海螺等模型，国内 api.minimax.io",
        "type": "openai_compatible",
        "default_base_url": "https://api.minimax.io/v1",
        "default_models": ["MiniMax-M2.5", "MiniMax-M2.5-highspeed", "MiniMax-M2.1", "MiniMax-M2"],
        "needs_api_key": True,
    },
    {
        "id": "langboat",
        "name": "澜舟 (孟子)",
        "description": "澜舟科技大模型，需配置 Base URL",
        "type": "openai_compatible",
        "default_base_url": "",
        "default_models": [],
        "needs_api_key": True,
    ...
    },
    {
        "id": "mianbi",
        "name": "面壁智能",
        "description": "面壁大模型与 Agent，需配置 Base URL",
        "type": "openai_compatible",
        "default_base_url": "",
        "default_models": [],
        "needs_api_key": True,
    ...
    # --- 国际 ---
    {
        "id": "together",
        "name": "Together AI",
        "description": "开源模型推理，按 token 计费",
        "type": "openai_compatible",
        "default_base_url": "https://api.together.xyz/v1",
        "default_models": ["meta-llama/Meta-Llama-3.1-70B-Instruct-Turbo", "openai/gpt-oss-20b", "Qwen/Qwen2.5-72B-Instruct-Turbo"],
        "needs_api_key": True,
    },
    {
        "id": "fireworks",
        "name": "Fireworks AI",
        "description": "高速推理，多开源模型",
        "type": "openai_compatible",
        "default_base_url": "https://api.fireworks.ai/inference/v1",
        "default_models": ["accounts/fireworks/models/llama-v3p1-70b-instruct", "accounts/fireworks/models/qwen-2.5-7b-instruct"],
        "needs_api_key": True,
    },
    {
        "id": "mistral",
        "name": "Mistral AI",
        "description": "Mistral / Mixture 系列",
        "type": "openai_compatible",
        "default_base_url": "https://api.mistral.ai/v1",
        "default_models": ["mistral-large-latest", "mistral-medium-latest", "open-mistral-7b", "codestral-latest"],
        "needs_api_key": True,
    },
    {
        "id": "cohere",
        "name": "Cohere",
        "description": "Command 等模型，OpenAI 兼容接口",
        "type": "openai_compatible",
    ...
    },
    {
        "id": "xai",
        "name": "xAI (Grok)",
        "description": "Grok 等模型，需以官方文档为准配置",
        "type": "openai_compatible",
        "default_base_url": "",
        "default_models": ["grok-2", "grok-2-mini"],
        "needs_api_key": True,
        "needs_base_url": True,
    },
    {
        "id": "azure_openai",
        "name": "Azure OpenAI",
        "description": "Azure 部署的 OpenAI 模型，Base URL 含资源名与 /openai/v1",
        "type": "openai_compatible",
        "default_base_url": "",
