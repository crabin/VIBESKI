...
subgraph "配置与日志"
CFG["配置模块<br/>vibeski_config/__init__.py"]
...
- [vibeski_config/__init__.py](file://vibeski_config/__init__.py#L162-L250)
- [utils/logger.py](file://utils/logger.py#L1-L51)
...
A --> E["vibeski_config/__init__.py"]
E --> F["utils/logger.py"]
...
- [vibeski_config/__init__.py](file://vibeski_config/__init__.py#L8-L14)
...
章节来源
- [vibeski_config/__init__.py](file://vibeski_config/__init__.py#L127-L149)
...
### 4. 运行时错误与日志分析
- 后端/CLI 异常会写入 vibeski_error.log 并打印到 stderr；冻结模式会在退出前暂停以便查看。
