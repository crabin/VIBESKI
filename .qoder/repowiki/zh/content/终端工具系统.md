...
- [vibeski/launch_tui.py](file://vibeski/launch_tui.py)
...
```mermaid
graph TB
A["main.py<br/>应用入口"] --> B["vibeski/launch_tui.py<br/>启动协调器"]
...
- [vibeski/launch_tui.py:1-343](file://vibeski/launch_tui.py#L1-L343)
...
## 核心组件
- 应用入口与 CLI：main.py 与 vibeski/cli.py 提供统一入口与参数解析，支持后端、TUI 单独启动与模型选择。
- 启动协调器：vibeski/launch_tui.py 负责后端与 TUI 的启动顺序、端口占用检测、TTY 检测与错误处理。
...
graph TB
subgraph "入口层"
CLI["CLI 启动器<br/>main.py / vibeski/cli.py"]
LT["启动协调器<br/>vibeski/launch_tui.py"]
end
subgraph "后端服务"
...
**图表来源**
- [vibeski/cli.py:34-100](file://vibeski/cli.py#L34-L100)
- [vibeski/launch_tui.py:291-343](file://vibeski/launch_tui.py#L291-L343)
...
**图表来源**
- [vibeski/launch_tui.py:143-343](file://vibeski/launch_tui.py#L143-L343)
...
- [vibeski/launch_tui.py:101-141](file://vibeski/launch_tui.py#L101-L141)
- [vibeski/cli.py:14-32](file://vibeski/cli.py#L14-L32)
