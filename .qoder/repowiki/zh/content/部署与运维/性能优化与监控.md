...
- 配置中心：vibeski_config集中管理数据库URL、日志级别、模型参数等。
...
- [core/executor.py](file://core/executor.py#L17-L179)
- [vibeski_config/__init__.py](file://vibeski_config/__init__.py#L223-L246)
...
API --> Logger["Logger"]
Config["vibeski_config.Settings"] --> DB
Config --> Logger
```
...
章节来源
- [vibeski/launch_tui.py](file://vibeski/launch_tui.py#L126-L174)
- [database/manager.py](file://database/manager.py#L75-L203)
