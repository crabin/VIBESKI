...
- 配置管理：通过vibeski_config.settings集中管理Ollama地址、模型等参数。
...
章节来源
- [__init__.py](file://vibeski_config/__init__.py#L162-L246)
...
- Ollama相关配置
  ...
  - 示例路径：[配置类](file://vibeski_config/__init__.py#L162-L174)
- 数据库路径
  - DATABASE_URL解析为SQLite文件路径
  - 示例路径：[数据库路径解析](file://vibeski_config/__init__.py#L35-L43)