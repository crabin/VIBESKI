...
subgraph "配置与依赖"
CFG["vibeski_config.Settings<br/>Ollama 配置"]
...
- 生成层：OllamaEmbeddings 提供异步嵌入生成，配置来源于 vibeski_config.Settings。
...
- 异步嵌入生成
  ...
  - 校验返回向量非空，记录调试日志。
- 配置来源
  - 从 vibeski_config.Settings 读取 Ollama 基础地址与嵌入模型名。
- 维度处理
...
章节来源
- [utils/embeddings.py](file://utils/embeddings.py#L11-L80)
- [vibeski_config/__init__.py](file://vibeski_config/__init__.py#L168-L173)
...
## 附录
- 配置项参考
  - Ollama 基础 URL 与嵌入模型名来自 vibeski_config.Settings。
- 测试与验证
