...
- 配置与路径：vibeski_config/__init__.py
...
subgraph "配置"
CFG["vibeski_config.Settings<br/>DATABASE_URL/路径解析"]
end
MM --> STM
MM --> EPI
MM --> LTM
...
- [vibeski_config/__init__.py](file://vibeski_config/__init__.py#L35-L44)
...
- vibeski_config.Settings：数据库路径与嵌入模型等配置解析
...
- vibeski_config.Settings：解析DATABASE_URL确定数据库路径，提供Ollama嵌入模型与基础URL等配置
...
CFG["vibeski_config.Settings"] --> DBM
CFG --> OLL
```
