...
CFG["Settings.database_url<br/>vibeski_config/__init__.py"]
end
subgraph "数据模型层"
...
- [vibeski_config/__init__.py](file://vibeski_config/__init__.py#L35-L43)
...
- 默认路径：若未配置，使用项目根目录/data/vibeski.db。
