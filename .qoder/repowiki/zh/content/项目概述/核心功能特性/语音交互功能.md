...
- 配置与环境变量：vibeski_config/__init__.py
...
C["vibeski_config/__init__.py<br/>配置与环境变量"]
end
subgraph "前端/集成"
...
- [vibeski_config/__init__.py](file://vibeski_config/__init__.py#L162-L207)
...
- [vibeski_config/__init__.py](file://vibeski_config/__init__.py#L194-L207)
