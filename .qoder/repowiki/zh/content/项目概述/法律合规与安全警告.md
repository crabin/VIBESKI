...
- [vibeski_security.yaml](file://prompts/templates/vibeski_security.yaml)
...
B --> G["提示词模板<br/>vibeski_security.yaml"]
...
- [vibeski_security.yaml](file://prompts/templates/vibeski_security.yaml#L76-L102)
...
subgraph "提示与规范"
PROMPT["vibeski_security.yaml<br/>操作指南/安全规范"]
end
U --> TUI
U --> APP
TUI --> API
